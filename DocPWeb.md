...
## **Introdução**
  ...
  O *front-end* da aplicação foi desenvolvido utilizando o framework do google `AngularJS 1.5.8` para a linguagem JavaScript e o `Bootstrap` para o Html e CSS, para o *front-end* a aplicação faz uso do PHP para manipulação
do banco de dados e o framework silex/symphony que faz a ligação entre o Angular e PHP com requisições HTTP(POST e GET).
